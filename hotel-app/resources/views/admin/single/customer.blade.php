    ...
    <div class="main">
        ...
        <main class="main">
            ...
            <div class="book-form-container">
                <form action="/customer/{{$customer->id ?? 'new'}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') ?? $customer->user->email}}" autocomplete="email">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city') ?? $customer->city}}" required autocomplete="city" autofocus>
